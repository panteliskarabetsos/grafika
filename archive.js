...
//   // Σχεδίαση
//  drawRobot(uModelMatrix, program); // θα καλέσει όλα τα μέρη
...
//   // Ανασχεδίαση
//   gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
//   drawRobot(uModelMatrix, program); //Επανασχεδιάζει το ρομπότ μετά από αλλαγή κάμερας
//   console.log("View Angle (deg):", viewAngleDeg);
// }

// function drawCube(scaleVec, translateVec, color, uModelMatrix, program) {
...
//   // Ενημέρωση χρώματος
//   const colors = [];
//   for (let i = 0; i < 36; i++) colors.push(...color);
...
// function drawRobot(uModelMatrix,program) {
//   // Πατούσες (κόκκινο)
//   drawCube([4, 6, 2], [-3, -1, 5], [1.0, 0.0, 0.0], uModelMatrix,program);
//   drawCube([4, 6, 2], [ 3, -1, 5], [1.0, 0.0, 0.0], uModelMatrix,program);

//   // Πόδια (κίτρινο)
//   drawCube([4, 4, 10], [-3, 0, 11], [1.0, 1.0, 0.0],uModelMatrix,program);
//   drawCube([4, 4, 10], [ 3, 0, 11], [1.0, 1.0, 0.0],uModelMatrix,program);

//   // Κορμός (κόκκινο)
//   drawCube([10, 6, 12], [0, 0, 27], [1.0, 0.0, 0.0],uModelMatrix,program);

//   // Χέρια (κίτρινο)
//   drawCube([4, 4, 10], [-7, 0, 27], [1.0, 1.0, 0.0],uModelMatrix,program);
//   drawCube([4, 4, 10], [ 7, 0, 27], [1.0, 1.0, 0.0],uModelMatrix,program);

//   // Κεφάλι (κίτρινο)
//   drawCube([6, 6, 6], [0, 0, 40], [1.0, 1.0, 0.0],uModelMatrix,program);
// }